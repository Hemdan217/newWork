...
chrome.runtime.onMessage.addListener(async function(request, sender, sendResponse) {
    if (request.prediction == "MALICIOUS") setTimeout(()=>{
        createNewDiv();
    }, 350);
    await chrome.runtime.sendMessage({
        action: "changeIcon",
